...
staging_events = "DROP TABLE IF EXISTS staging_events_table"
staging_songs = "DROP TABLE IF EXISTS staging_songs_table"
songplay = "DROP TABLE IF EXISTS songplay_table"
users = "DROP TABLE IF EXISTS user_table"
songs = "DROP TABLE IF EXISTS song_table"
artist = "DROP TABLE IF EXISTS artist_table"
time = "DROP TABLE IF EXISTS time_table"
