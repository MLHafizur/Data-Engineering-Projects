...
we'll be provided with a helpers class that contains all the SQL transformations. Thus, we won't need to write the ETL yourselves, but we'll need to execute it with our custom operators.
